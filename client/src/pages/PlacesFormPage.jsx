...
export default function PlaceFormPage(){
  const {id} = useParams();
      ...
      // Function to handle the adding of a new place
    ...
    <AccountNav />
        <form onSubmit={savePlace}>
          ...
          {preInput('Check-in & Check-out times', 'Add check-in and check-out times, remember to leave some time for cleaning')}
